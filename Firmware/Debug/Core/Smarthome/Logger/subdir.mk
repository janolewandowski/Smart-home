...
C_SRCS += \
../Core/Smarthome/Logger/logger.c 

OBJS += \
./Core/Smarthome/Logger/logger.o 

C_DEPS += \
./Core/Smarthome/Logger/logger.d 


# Each subdirectory must supply rules for building sources it contributes
Core/Smarthome/Logger/%.o Core/Smarthome/Logger/%.su: ../Core/Smarthome/Logger/%.c Core/Smarthome/Logger/subdir.mk
...
clean: clean-Core-2f-Smarthome-2f-Logger

clean-Core-2f-Smarthome-2f-Logger:
	-$(RM) ./Core/Smarthome/Logger/logger.d ./Core/Smarthome/Logger/logger.o ./Core/Smarthome/Logger/logger.su

.PHONY: clean-Core-2f-Smarthome-2f-Logger
