...
C_SRCS += \
../Core/Smarthome/Classes/DIN/DIN.c 

OBJS += \
./Core/Smarthome/Classes/DIN/DIN.o 

C_DEPS += \
./Core/Smarthome/Classes/DIN/DIN.d 


# Each subdirectory must supply rules for building sources it contributes
Core/Smarthome/Classes/DIN/%.o Core/Smarthome/Classes/DIN/%.su: ../Core/Smarthome/Classes/DIN/%.c Core/Smarthome/Classes/DIN/subdir.mk
...
clean: clean-Core-2f-Smarthome-2f-Classes-2f-DIN

clean-Core-2f-Smarthome-2f-Classes-2f-DIN:
	-$(RM) ./Core/Smarthome/Classes/DIN/DIN.d ./Core/Smarthome/Classes/DIN/DIN.o ./Core/Smarthome/Classes/DIN/DIN.su

.PHONY: clean-Core-2f-Smarthome-2f-Classes-2f-DIN
